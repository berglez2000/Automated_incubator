...
void loop()
{
    ...
    if (menuOption == '1')
    {
        ...
        stepperGeared.step(1, circle); // move motor 1000 steps in one direction
        delay(1000);                   // short stop
        stepperGeared.step(0, circle); // move motor 1000 steps in the other dirction
        delay(1000);                   //short stop
    }
...
char menu()
{
    ...
    Serial.println(F("(1) Small Reduction Stepper Motor with EasyDriver - 5VDC 32-Step 1/16 Gearing"));
